...
export default function Landing({
  ...
  // require("@assets/images/landing-page/hero.png"),
  // ]);
      ...
      >
        <Container variant="landing">
          ...
          >
            ...
            >
              <PrimaryButton
                actionWord=" Sign up as  a Dispatcher"
      ...
      >
        <Container variant="landing">
          ...
          >
            ...
            >
              With order verification, customer support, and admin monitoring,
              SendMe ensures every transaction is safe and reliable.
            </Text>

            <Box style={styles.downloadButtonGroup}>
              <PrimaryButton
                href="/"
                actionWord="Download the App"
                buttonColor={buttonColor}
                textColor={textColor}
              />
            </Box>
          ...
          {Platform.OS === "web" && (
            ...
            >
              ...
              >
                <AccordionItem
                  value="item-1"
                  className=" rounded-lg bg-transparent border-primary-0"
                ...
                <AccordionItem
                  value="item-2"
                  className="mt-5 rounded-lg bg-transparent border-primary-0"
                >
                  <AccordionHeader>
