            ...
            <Container>
                <Box className=" min-h-screen max-w-3xl mx-auto  px-6 sm:px-0 py-20 sm:py-14 z-10 relative flex flex-row items-center justify-center ">
                    ...
                    <Box className='w-full h-full flex flex-row-reverse items-center justify-center  rounded-2xl '>
                        <Box className='flex-1 flex flex-col gap-y-6 items-center justify-center rounded-2xl lg:rounded-2xl sm:px-6  h-screen min-h-[500px]  sm:shadow-md  shadow-secondary-300 dark:shadow-secondary-200/20 '>
                            ...
                            >
                                ...
                                <Box className="flex justify-center flex-col gap-3 items-center">
                                    <Link href="/auth/user/login">
                                        <Text className='text-center text-sm dark:text-white text-black hover:underline '>Go To Login</Text>
                                    </Link>
