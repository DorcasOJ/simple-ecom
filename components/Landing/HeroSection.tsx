...
export default function HeroSection({
  ...
  const imageLoaded = usePreloadAssets([
          ...
          >
            <Text
              style={{
                ...
                fontWeight: 700,
                color: textColor,
                fontSize: Platform.OS === "web" ? 60 : 38,
                ...Platform.select({
                  web: {
                    lineHeight: 1,
                  },
            ...
            >
              ...
              order items, track deliveries, and enjoy secure payments.
            </Text>
            ...
            >
              ...
              <Link href="/auth/user/login" asChild>
                <TouchableOpacity
                  activeOpacity={0.8}
                  style={{
