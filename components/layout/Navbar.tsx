...
const Navbar = ({ page, colorMode, toggleColorMode, user }: NavbarProps) => {
  const logoLoaded = usePreloadAssets([
    ...
    <Box className="w-full" style={styles.fullWidth}>
      ...
      >
        {page === "landing" ? (
          ...
          >
            <Box
              className={`w-full items-center justify-between flex flex-row p-5 ${
                page === "landing"
            ...
            >
              {/* Logo section */}
              <Box
                className="flex items-end-safe gap-x-3"
                style={styles.logoRow}
              >
                <Box
                  className="h-16 w-[110px] sm:w-[150px]"
              ...
              {page === "landing" ? (
                ...
                <>
                  ...
                  <Box
                    className={`flex flex-row items-center justify-center gap-x-2 sm:gap-x-5 text-black dark:text-white ${
                      page === "auth" && "me-8 sm:me-10"
                    }`}
            ...
            style={StyleSheet.flatten([
              {
                ...
                backgroundColor:
                  colorMode === "dark" && page === "auth" ? "black" : "white",
              },
              ...
              {page === "landing" ? (
                ...
                <>
                  ...
                  >
                    ...
                    <Link href={"/"} style={styles.cartLink}>
                      <Text>
                        <ShoppingCart size={20} />
                      </Text>
                      <Text
