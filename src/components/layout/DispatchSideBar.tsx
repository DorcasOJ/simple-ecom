...
const DispatchSideBar = ({ children }: { children: React.ReactNode }) => {
    return (
                        ...
                        <div className="drawer-side mt-0 ">
                            ...
                            <div className="menu bg-base-200 text-base-content min-h-full w-60 sm:w-70 px-4 ">
                                <ul className="mt-40 lg:mt-0 space-y-2 pt-5">
                                    ...
                                    <li>
                                        <Link to={ROUTES.DISPATCH_HOME} className="py-2 flex items-center hover:bg-primary hover:text-primary-content">
                                            <span>
                                                <Home size={"20px"} />
                                            </span>
                                    ...
                                    <li>
                                        <Link to={ROUTES.USERS_SUPPORT} className="py-2 flex items-center hover:bg-primary hover:text-primary-content">
                                            <span>
                                                <Headset size={"20px"} />
                                            </span>
                                    ...
                                    <li>
                                        <Link to={ROUTES.USERS_PROFILE} className="py-2 flex items-center hover:bg-primary hover:text-primary-content">
                                            <span>
                                                <User size={"20px"} />
                                            </span>
