...
export default function HeroSection() {
  ...
  const gradient = useSpring({
    ...
    // from: { background: "linear-gradient(120deg, #2563EB, #06B6D4)" },
    // to: { background: "linear-gradient(120deg, #1D4ED8, #0891B2)" },
    from: {
      ...
      <Container>
        <div className="flex flex-col md:flex-row items-center lg:items-start justify-center lg:justify-between gap-5">
          ...
          >
            ...
            >
              SendMe is your all-in-one shopping and delivery companion. Easily
              order items, track deliveries in real-time, rate dispatchers, and
              enjoy secure payments. Whether you’re shopping, delivering, or
              receiving — SendMe keeps everyone connected.
            </motion.h2>
            ...
            >
              <Link to={ROUTES.USER_LOGIN}>
                <motion.button
                  ...
                  className="px-6 py-3 bg-primary text-white rounded-full font-semibold shadow-lg"
                >
                  Start Shopping
                </motion.button>
              </Link>
