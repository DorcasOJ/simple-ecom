  ...
  const quickHelp = [
    {
      ...
      desc: "Track your current and past orders",
      color: "text-red-500",
    },
    {
      icon: HelpCircle,
      title: "How to cancel an order?",
      desc: "Learn about our cancellation policy",
    },
    {
      icon: HelpCircle,
      title: "Report an issue",
      desc: "Report problems with orders or deliveries",
    },
    {
      icon: CreditCard,
      title: "Payment problems",
      desc: "Get help with payment and billing issues",
    },
    {
      icon: Store,
      title: "Store availability",
      desc: "Check which stores deliver to your area",
    },
    {
      icon: Star,
      title: "Rate & Review",
            ...
            <div className="lg:col-span-1 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-3">
                {quickHelp.map((item, i) => (
                  ...
                  >
                    <item.icon
                      className={`w-5 h-5 mt-1 ${item.color || "text-gray-600"}`}
                    />
                    <div>
